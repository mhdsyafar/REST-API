      ...
      <div class="col-md mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="<?= base_url(); ?>../wpu-hut/latihan1.php" class="card-link see-detail" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`">See Project</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="<?= base_url(); ?>../wpu-res-server/" class="card-link see-detail" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`">See Project</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="<?= base_url(); ?>index.php/home" class="card-link see-detail" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`">See Project</a>
          </div>
        </div>
      </div>
    </div>
