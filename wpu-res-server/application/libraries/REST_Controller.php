...
{
    // Deklarasikan variabel untuk menyimpan metode
    $method = NULL;

    // Tentukan apakah pengaturan 'enable_emulate_request' diaktifkan
    if ($this->config->item('enable_emulate_request') === TRUE)
    {
        ...
        // Pastikan $method tidak null sebelum memanggil strtolower
        if ($method !== NULL) {
    ...
    if (empty($method))
    {
        // Dapatkan metode permintaan sebagai string huruf kecil
